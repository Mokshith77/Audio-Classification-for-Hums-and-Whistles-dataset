Basic solution : Using the MLEnd Hums and Whistles dataset, I builT a machine learning pipeline that takes a Potter or a StarWars audio segment and predicts its song label (either Harry or StarWars).
